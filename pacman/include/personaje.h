...
class personaje : public entidad
{
    public:
        ...
        personaje(){
            ...
            pacman2_mb = load_bitmap ("pacman2.bmp",NULL);
        ...
        void dibujarPersonaje(escenario escenario1, bool bocaAbierta, int numPacman){
            ...
            if (numPacman == 1){
                ...
                if (bocaAbierta==true)
                    blit(pacman2_mb, pacman, direccion*30,0,0,0,30,30);

                else
                    blit(pacman2_mb,pacman,1*30,0,0,0,30,30);}

            else if (numPacman == 3){
                if (bocaAbierta==true)
                    blit(pacman3_mb, pacman, direccion*30,0,0,0,30,30);

                else
                    blit(pacman3_mb,pacman,1*30,0,0,0,30,30);}
        ...
        void movimiento( escenario e1, int numJugadores, int numMapa){
